...
public abstract class RandomWaitingMessageProcessor extends MessageProcessorBehaviour {
	private static final long serialVersionUID = 1L;
	
	private int low;
	private int high;
		
	public RandomWaitingMessageProcessor(int low, int high, MessageTemplate template) {
		super(template);
		this.low = low;
		this.high = high;
	}
